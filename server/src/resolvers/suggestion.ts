...
import { createNewSuggestion, getAllSuggestions, mapUpvoteCountToSuggestionsByUserId } from "../helpers/suggestions";
import { getUserById } from "../helpers/users";

export const resolveCreateSuggestion = async (_: any, { title, category, detail, createdBy }: any, { authToken }: any) => {
...
export const resolveGetAllSuggestionsWithUpvotes = async (_: any, { userId }: any) => {
